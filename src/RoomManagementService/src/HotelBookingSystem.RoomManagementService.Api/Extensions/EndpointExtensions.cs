...
namespace HotelBookingSystem.RoomManagementService.Api.Extensions
{
    public static class EndpointExtensions
    {
        public static WebApplication MapRoomManagementEndpoints(this WebApplication app)
        {
            ...
            var v1Group = apiGroup.MapGroup("/v1").WithTags("Room Management Service API v1");
            HotelEndpoints.MapHotelEndpoints(v1Group);
            RoomTypeEndpoints.MapRoomTypeEndpoints(v1Group);
        ...
        public static WebApplication MapVersionedEndpoints(this WebApplication app)
        {
            ...
            var v2Group = apiGroup.MapGroup("/v2").WithTags("Room Management Service API v2");
